	...
	<div class="col-xs-12">
		<form action="<?php echo htmlentities($_SERVER['PHP_SELF']) ?>" method="POST" class="signup form-group">
			...
			<div class="form-control">
				...
				<input type="text" class="input-phchat" name="username" autocomplete="off" placeholder="Username" />
			</div>
			<div class="form-control">
				<label for="Email" class="sr-only">Email</label>
				<input type="email" class="input-phchat" name="email"autocomplete="off"  placeholder="Email" />
			</div>
			<div class="form-control">
				<input type="password" class="input-phchat" autocomplete="off" name="password" placeholder="Password" />
			</div>
